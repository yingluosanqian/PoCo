...
class Settings:
    ...
    claude_command: str = field(default_factory=lambda: getenv("POCO_CLAUDE_COMMAND", "claude"))
    claude_workdir: str = field(default_factory=lambda: getenv("POCO_CLAUDE_WORKDIR", DEFAULT_REPO_ROOT))
    claude_model: str | None = field(default_factory=lambda: getenv("POCO_CLAUDE_MODEL", "sonnet"))
    claude_permission_mode: str = field(default_factory=lambda: getenv("POCO_CLAUDE_PERMISSION_MODE", "default"))
    claude_timeout_seconds: int = field(default_factory=lambda: int(getenv("POCO_CLAUDE_TIMEOUT_SECONDS", "900")))
