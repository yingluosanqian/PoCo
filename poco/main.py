    ...
    card_dispatcher = CardActionDispatcher(
        {
            ...
            "workspace.choose_session": workspace_intent_handler,
            "workspace.apply_session": workspace_intent_handler,
            "workspace.enter_session_id": workspace_intent_handler,
            "workspace.apply_entered_session_id": workspace_intent_handler,
            "workspace.clear_session": workspace_intent_handler,
