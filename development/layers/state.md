...
- 已存在最小 session lifecycle 动作，当前 workspace card 可显式 `New Session` 和 `Close Session`
...
- 当前 session 虽已可见、可操作，但仍未具备显式 `continue`、多 session timeline 或 richer handoff 展示
